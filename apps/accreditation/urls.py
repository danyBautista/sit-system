...
from apps.accreditation.views import accreditationCreate, accreditationIndex, accreditationView, accreditationUpdate, TypeCreate, accreditationSearch, accreditationForm
