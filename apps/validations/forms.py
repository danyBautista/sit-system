...
class ProcedureForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'property_card' : forms.CheckboxInput(attrs={'class':'d-none'}),
            ...
            'RRPP_Newsletter' : forms.CheckboxInput(attrs={'class':'d-none'}),
            'owner' : forms.TextInput(attrs={'type':'hidden'}),
            'contract' : forms.TextInput(attrs={'type':'hidden'}),
            'bonding_contract' : forms.CheckboxInput(attrs={'class':'d-none'}),
            'enabled' : forms.TextInput(attrs={'type':'hidden'}),
            'vehicle_authorization' : forms.CheckboxInput(attrs={'class':'d-none'}),
            'check_sistran' : forms.CheckboxInput(attrs={'class':'d-none'}),
